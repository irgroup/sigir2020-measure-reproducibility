...
% 2) Computes ARP and unpaired ttest
...
for o_r_n = original_run_names
    ...
    for m = measures
        ...
        file_path_original_run = sprintf('%sorg_%s_%s.csv', inputh_path, o_r_n{:}, m{:});
...
for r = 1:length(run_numbers_print)
    ...
    fprintf('\\texttt{%s}\t& $%.4f$\t& $%.4f$\t& $%.4f$\t& $%.4E$\t& $%.4E$\t& $%.4E$\t& $%.4f$\t& $%.4f$\t& $%.4f$\t& $%.4E$\t& $%.4E$\t& $%.4E$ \\\\\n', ...
        strrep(new_name, '_', '\_'), ...
        p10_wcrobust04_run, ap_wcrobust04_run, ndcg1000_wcrobust04_run, ...
        p10_pvalue_wcrobust04_run, ap_pvalue_wcrobust04_run, ndcg1000_pvalue_wcrobust04_run, ...
        p10_wcrobust0405_run, ap_wcrobust0405_run, ndcg1000_wcrobust0405_run, ...
